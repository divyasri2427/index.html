...
<!-- Header -->
<header>
    <img  src="divya sri.jpeg" width="120" height="120">
    <h1>Divya sri.R</h1>
...
<section id="about">
    <div class="container">
        <h2>About Me</h2>
        <p>
            Hi! I'm  divya sri.R a passionate student at Patrician College, exploring the world of web development and coding. 
...
<section  id="contact">
    <div class="container">
        ...
        <p style='color: #051305;'>Email: <a href="mailto:Divya sri.R@example.com">divya sri.R@example.com</a></p>
...
<footer>
    <p>&copy; 2025 R.divya sriAll rights reserved.</p>
</footer>
